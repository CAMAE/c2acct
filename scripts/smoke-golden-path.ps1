...
Write-Host "AUTH_PROVIDER: GitHub via Auth.js v5 JWT session"
Write-Host "NEXT_STEP: Sign in via $Base/login with a pre-approved GitHub account, then validate submit/results/outputs in browser session."
