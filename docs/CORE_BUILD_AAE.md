...
- Exact `public/PAT.png` brand proof is currently missing; existing brand assets are not a substitute for that exact artifact.
...
- MISSING: exact `public/PAT.png` brand artifact proof.
...
- add exact `public/PAT.png` brand proof if that asset is required for public launch
