...
3. Sales Card v1 for vendors (query + ranked fit list + evidence bullets).
...
- **Module 3 (Flow / Bullet Theory / Framing) → the Sales Card layout.** Each card = one bullet: single claim, single evidence line, single next action. The Tinder-card five-fact cap comes straight from this.
