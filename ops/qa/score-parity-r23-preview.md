# Score parity · preview-before (ep-wispy-snow-apevna3q-pooler.c-7.us-east-1.aws.neon.tech) vs preview-after (ep-wispy-snow-apevna3q-pooler.c-7.us-east-1.aws.neon.tech) · 2026-09-14T06:46:18.739Z

Firms in both: 140 (only preview-before: 0; only preview-after: 0). Products in both: 94 (only preview-before: 0; only preview-after: 0).
Firm differences: 0; product differences: 33; of which explained by a newer submission on preview-after: 0.

## Firm differences

| firm | index preview-before→preview-after | modules | newest submission preview-before / preview-after | cause |
|---|---|---|---|---|

## Product differences

| product | self % | firm-reviewed % | divergence | reviews | newest submission preview-before / preview-after | cause |
|---|---|---|---|---|---|---|
