...
export function getAuthRuntimeStatus(): AuthRuntimeStatus {
  ...
  const callbackExample = resolved.callbackUrl ?? "http://localhost:3000/api/auth/callback/github";
  ...
  return {
    ...
    operatorSteps: [
      "Set AUTH_URL or NEXTAUTH_URL to your local app origin and use the same origin in the browser.",
