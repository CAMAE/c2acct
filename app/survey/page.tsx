    ...
    <>
      ...
      <section className="space-y-8">
        <div className="pat-card-strong p-8">
          <div className="pat-label text-white/58">Assessment Readiness</div>
          ...
          <p className="mt-5 max-w-3xl text-base leading-7 text-white/74">
            This page confirms the current institutional scope before the module opens. PAT keeps the assessment radically simple, but the workflow still needs to feel deliberate, calm, and safe.
          </p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.9fr)]">
          ...
          {!companyReady ? (
            ...
            <>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link className="pat-button-primary" href={`/survey/${MODULE_KEY}`}>
                  Start assessment
                </Link>
