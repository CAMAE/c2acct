...
// Block 21-0 (Mythos): the trust hero no longer shows a "Last updated" date — a
// build-date label there advanced ahead of the actual content revision (a too-fresh
// date). B7's build-driven date is not reversed, it's relocated to where it belongs:
// /release (the release-fingerprint surface). No other surface consumed this helper.
